        # Pwcvr2: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/pwcvR2.git

        ## Objective

        PairwiseCV R2 provides cross-validated R-squared estimation for meta-regression models, quantifying the proportion of heterogeneity explained by study-level covariates.
        ...
        - Code: https://github.com/mahmood726-cyber/pwcvR2.git
        - Dashboard: N/A
